 ...
 * TODO: make use of comomon-api Identifier class
 *
 * @see <a href="http://rs.gbif.org/extension/gbif/1.0/identifier.xml">Identifier Definition</a>
 */
public class Identifier extends NameUsageComponent {
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(super.hashCode(), identifier, type, title);
  }
