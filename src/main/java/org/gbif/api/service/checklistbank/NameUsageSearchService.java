...
public interface NameUsageSearchService
  extends SearchService<NameUsageSearchResult, NameUsageSearchParameter, NameUsageSearchRequest>,
  SuggestService<NameUsageSuggestResult, NameUsageSearchParameter, NameUsageSuggestRequest> {
