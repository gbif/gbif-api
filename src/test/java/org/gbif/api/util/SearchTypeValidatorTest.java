...
public class SearchTypeValidatorTest {
  ...
  public static Collection<Object[]> data() {
    Object[][] data = {
      ...
      {GEOMETRY, "POLYGON ((30 10, 10 20, 20 40, 40 40, 30 10),)", false, false},
      {GEOMETRY, "POLYGON ((30.12 10, 10 20, 20 40, 40 40, 30.12 10.01))", false, false}, // valid wkt, although not a closed polygon
      {GEOMETRY, "POLYGON  ( (30 10 , 10 20 , 20 40 , 40 40 , 30 20)  )", false, false}, // valid wkt, although not a closed polygon
      {GEOMETRY, "POLYGON ((35 10, 10 20, 15 40, 45 45, 35 10),(20 30, 35 35, 30 20, 20 30))", true, false}, // valid donut
      {GEOMETRY, "POLYGON ((35 10, 10 20, 15 40, 45 45, 35 10),(20 30, 35 35, 30 20, 20 30))", true, false},
      {GEOMETRY, "MULTIPOLYGON (((35 10, 10 20, 15 40, 45 45, 35 10)),((20 30, 35 35, 30 20, 20 30)))", false, false}, // invalid, overlaps
      {GEOMETRY, "MULTIPOLYGON (((35 10, 10 20, 15 40, 45 45, 35 10)),((120 30, 135 35, 130 20, 120 30)))", true, false},
